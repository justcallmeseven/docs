...
- cd ../..：返回上两级目录
  ...
  > 在“username@seaserversname:~$”这个目录的，cd /etc后怎么回到“username@seaserversname:~$”
  >
  > 看到的：
  >
  > ```
  > username@seaserversname:~$
  > ```
  >
  > 其中：
  >
  ...
  >
  > ```
  > username@seaserversname:/home/username$
  > ```
  >
  > #### 方法1：最常用
  >
